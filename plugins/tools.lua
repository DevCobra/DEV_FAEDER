...
if matches[1] == 'المطور'  then
   tg.sendMessage(msg.chat_id, msg.id_, 1, '@G0vip', 1)
end
if matches[1] == 'السورس'  then
   tg.sendMessage(msg.chat_id, msg.id_, 1, 'اهلا بك في سورس THE_COBRA السورس https://github.com/DevCobra/THE_COBRA', 1)
end
if matches[1] == 'اريد بوت'  then
   tg.sendMessage(msg.chat_id, msg.id_, 1, ' تعال هنا @G0vip', 1)
end
if matches[1] == 'مطور'  then
   tg.sendMessage(msg.chat_id, msg.id_, 1, ' 9647727671765  ', 1)
if matches[1] == 'ضوجه'then
   tg.sendMessage(msg.chat_id, msg.id_, 1, ' يــــِٰٰٰٰٰٰٰـٰٰٰٰٓٓٓٓـٰٰٓٓـٰٓـٓــعٰـــــِٰٰٰٰٰٰٰـٰٰٰٰٓٓٓٓـٰٰٓٓـٰٓـٓـنـًًًًًًـٰـي شـﮩ๋͜͡‏ــًًًًًـتـــﮩ๋͜͡‏ـبہًًًـريـًًًًد اركـৡﮩـہٌَـصـًًًًًًًلـًًًًًًك انـًًًًًًًًًًي هـৡﮩـم ضـہٌَـايـًًًج  ', 1)
end
if matches[1] == 'مح'  then
   tg.sendMessage(msg.chat_id, msg.id_, 1, ' هاي ليش تبوسني بااع الحديق حتكفر 😹💋 
  ', 1)
end
